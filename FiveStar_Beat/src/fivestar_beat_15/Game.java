...
public class Game extends Thread{
	...
	private Image flareimageImage = new ImageIcon(Main.class.getResource("../images/flareimage.png")).getImage();
	...
	public void screenDraw(Graphics2D g) {
		...
		g.drawImage(flareimageImage, 350, 200,  null);
	}
